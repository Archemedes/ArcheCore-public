...
public class UpdateVitalsRow extends SingleStatementRow {
	...
	protected Object getValueFor(int index) {
		...
		case 8: return inv == null ? null : inv.getInvAsString();
		case 9: return inv == null ? null : inv.getEnderInvAsString();
		case 10: return potions;
		case 11: return persona.getPersonaId();
