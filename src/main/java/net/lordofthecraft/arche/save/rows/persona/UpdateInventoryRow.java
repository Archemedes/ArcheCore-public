...
public class UpdateInventoryRow extends SingleStatementRow {
    ...
    protected Object getValueFor(int index) {
        switch (index) {
            case 1:
                return InventoryUtil.isEmpty(inv.getInventory()) ? null : inv.getInvAsString();
            case 2:
                return InventoryUtil.isEmpty(inv.getEnderInventory()) ? null : inv.getEnderInvAsString();
            case 3:
                return inv.getPersona().getPersonaId();
            default:
