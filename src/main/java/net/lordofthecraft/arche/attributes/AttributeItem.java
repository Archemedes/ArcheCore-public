...
public class AttributeItem {
	...
	public static LinkedHashMap<String, Object> serialize(ItemStack is) {
		...
		net.minecraft.server.v1_10_R1.ItemStack nmsItemStack = null;
		try {
			nmsItemStack = (net.minecraft.server.v1_10_R1.ItemStack) toNMSStack(is);
		} catch (Exception e) {
		}
	...
	public static ItemStack addModifier(Long least, Long most, Object compound, ItemStack is){
		try {
			net.minecraft.server.v1_10_R1.ItemStack nmsItemStack = (net.minecraft.server.v1_10_R1.ItemStack) toNMSStack(is);
			...
			setTagMethod.invoke(nmsItemStack, tag);*/
				nmsItemStack.setTag((net.minecraft.server.v1_10_R1.NBTTagCompound) tag);
